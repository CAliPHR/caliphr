...
public interface DataPoolFactory {
	 ...
	 */
	String[] getDBCommitOrder();

	/** As getDBCommitOrder but returns type safe classes instead. */
	Class<?>[] getDBClassCommitOrder();

	/**
	 * @param className classname to return
	 * @return the tabledeps for the given class name
	 */
	Collection<String> getTabledeps(String className);
