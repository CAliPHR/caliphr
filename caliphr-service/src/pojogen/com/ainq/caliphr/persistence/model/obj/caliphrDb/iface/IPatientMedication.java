...
/** 
 * Object interface mapping for hibernate-handled table: patient_medication.
...
public interface IPatientMedication {
	 ...
	 */
	void setAdministrationCode(final Code administrationCode);
	 ...
	 */
	String getAdministrationCodeDescription();
	 ...
	 */
	void setAdministrationCodeDescription(final String administrationCodeDescription);
	 ...
	 */
	void setDoseQuantityValue(final String doseQuantityValue);
	 ...
	 */
	void setProductCode(final Code productCode);
	 ...
	 */
	void setRateQuantityValue(final String rateQuantityValue);
