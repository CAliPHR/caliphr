 ...
 */
public interface InstructionImporter {

    void loadPatientInstructions(POCDMT000040Section section, ClinicalDocument clinicalDocument, TemplateRoot templateRoot);
}
