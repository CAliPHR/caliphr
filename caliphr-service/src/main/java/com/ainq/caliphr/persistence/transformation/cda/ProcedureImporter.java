 ...
 */
public interface ProcedureImporter {

    void loadPatientProcedureEntry(POCDMT000040Entry entry, ClinicalDocument clinicalDocument, TemplateRoot templateRoot, List<CodeMapping> codeMappings, ExistingItemMap<PatientProcedure> existingProcedures);
}
