 ...
 */
public interface FuncCogStatusImporter {
    void loadPatientFuncCogStatusEntry(POCDMT000040Entry entry, ClinicalDocument clinicalDocument, TemplateRoot templateRoot);
}
