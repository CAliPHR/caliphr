 ...
 */
public interface ReasonForReferralImporter {
    void loadPatientReasonForReferrals(POCDMT000040Section section, ClinicalDocument clinicalDocument, TemplateRoot templateRoot);
}
