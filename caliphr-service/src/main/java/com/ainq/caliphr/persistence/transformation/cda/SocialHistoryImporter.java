 ...
 */
public interface SocialHistoryImporter {

    void loadPatientSocialHistoryEntry(POCDMT000040Entry entry, ClinicalDocument clinicalDocument, TemplateRoot templateRoot);
}
