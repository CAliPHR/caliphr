 ...
 */
public interface MedicalEquipmentImporter {

    void loadMedicalEquipmentEntry(POCDMT000040Entry entry, ClinicalDocument clinicalDocument, TemplateRoot templateRoot);
}
